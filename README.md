...
- If for any reason, there's a problem with the tests.conf file, the default values of the number of tests to run is now set to 0. Default values for the absence of optional parameters on the command line are also set to 0.
